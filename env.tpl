...
## CUSTOM VALUES FOR EACH CUSTOMER #############
REACT_APP_GOOGLE_MAPS_API_KEY=CUSTOMIZED_FOR_USER
ONPREM_DOMAIN=carto3-onprem.lan
CARTO_ONPREMISE_CARTO_DW_LOCATION=US
CARTO_ONPREMISE_VERSION=2021.11.17.01

## END CUSTOM VALUES FOR EACH CUSTOMER #############
