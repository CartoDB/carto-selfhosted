...
WORKSPACE_PUBSUB_TENANT_BUS_SUBSCRIPTION=projects/${SELFHOSTED_GCP_PROJECT_ID}/subscriptions/tenant-bus-sub
...
WORKSPACE_NOTIFIER_URL=http://notifier:5561/publish/
