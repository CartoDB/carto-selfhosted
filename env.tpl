...
DOCKER_REGISTRY_BASE_PATH=us-docker.pkg.dev/carto-onprem-artifacts/gcr.io
...
NOTIFIER_DOCKER_IMAGE=${DOCKER_REGISTRY_BASE_PATH}/notifier:${CARTO_SELFHOSTED_VERSION}
VALKEY_DOCKER_IMAGE=${DOCKER_REGISTRY_BASE_PATH}/valkey:${CARTO_SELFHOSTED_VERSION}
### WWW variables
...
REACT_APP_HOSTED_APPS_URL=https://${SELFHOSTED_DOMAIN}/app
...
WAREHOUSE_PROVIDERS_DATABRICKS_WAREHOUSE=true
WAREHOUSE_PROVIDERS_FABRIC=true
WAREHOUSE_PROVIDERS_ORACLE=true
...
# SSRF protection for the Workflows HTTP Request component. Enabled by default;
# override in customer.env to reach internal endpoints.
WORKSPACE_HTTP_REQUEST_RESTRICT_IPS=true
# WORKSPACE_HTTP_REQUEST_ALLOWED_IP_RANGES=<FILL_ME>
# WORKSPACE_HTTP_REQUEST_RESTRICTED_IP_RANGES=<FILL_ME>
