...
ACCOUNTS_API_DOCKER_IMAGE=${DOCKER_REGISTRY_BASE_PATH}/accounts-api:${CARTO_SELFHOSTED_VERSION}
...
INTEGRATION_TESTS_DOCKER_IMAGE=${DOCKER_REGISTRY_BASE_PATH}/integration-tests:${CARTO_SELFHOSTED_VERSION}
...
REACT_APP_PUBLIC_MAP_URL=https://${SELFHOSTED_DOMAIN}/workspace-api/maps/public
