...
### START VALUES FOR EACH CUSTOMER

# Fully qualified domain where CARTO will be accesible
ONPREM_DOMAIN=carto3-onprem.lan

GOOGLE_APPLICATION_CREDENTIALS=../certs/onprem-sa-key.json
...
WORKSPACE_GCS_THUMBNAILS_BUCKET=${ONPREM_GCP_PROJECT_ID}-thumbnails-storage
WORKSPACE_GCS_DATASETS_BUCKET=${ONPREM_GCP_PROJECT_ID}-client-storage

# If you want to use Google Maps and have a API KEY set it here
# REACT_APP_GOOGLE_MAPS_API_KEY=CUSTOMIZED_FOR_USER_IF_NEEDED
